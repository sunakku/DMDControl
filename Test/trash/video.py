...
for y in xrange(3):
    for x in xrange(6):
        rect = (x*Explosion.get_width()/6,y*Explosion.get_height()/3,Explosion.get_width()/6,Explosion.get_height()/3)
        Explosions.append(Explosion.subsurface(rect))
ExplosionFrame = -10

Font = pygame.font.Font("font.ttf",258)
